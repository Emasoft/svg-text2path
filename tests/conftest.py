...
def rtl_svg_content() -> str:
    ...
    return '''<?xml version="1.0" encoding="UTF-8"?>
<svg xmlns="http://www.w3.org/2000/svg" width="300" height="100" viewBox="0 0 300 100">
  <text x="290" y="50" font-family="Noto Sans Arabic" font-size="24" direction="rtl">مرحبا</text>
</svg>'''
...
<svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 200 200">
  <text x="50" y="50" font-family="Arial" font-size="24" transform="rotate(45, 50, 50)">Rotated</text>
</svg>'''
...
requires_fonts = pytest.mark.skipif(
    not Path("/System/Library/Fonts").exists() and not Path("/usr/share/fonts").exists(),
